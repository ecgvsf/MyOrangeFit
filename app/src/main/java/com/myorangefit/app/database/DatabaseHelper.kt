package com.myorangefit.app.database
...
import com.myorangefit.app.model.BodyPart
import com.myorangefit.app.model.Serie
import com.myorangefit.app.model.Workout
import com.myorangefit.app.model.WorkoutCalendar
import java.io.File
...
class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    fun getWeekWorkout(date: LocalDate): MutableList<Pair<String, Int>> {
        val db = readableDatabase
        var datesList = mutableListOf<Pair<String, Int>>()
        ...
        while (cursor.moveToNext()) {
            ...
            val q = cursor.getInt(cursor.getColumnIndexOrThrow("q"))
            datesList.add(Pair(data, q))
        }
        cursor.close()
